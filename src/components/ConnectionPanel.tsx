        ...
        <>
          ...
          <section className="module-card connection-form">
            <div className="connection-endpoints">
              <span><strong>{t("connection.direction")}</strong>{moduleOptionLabel(sourceNode, selectedEdge.source)} {"->"} {moduleOptionLabel(targetNode, selectedEdge.target)}</span>
              <span><strong>{t("connection.relationType")}</strong>{t(`relation.${selectedEdge.relation}`)}</span>
              <span><strong>{t("connection.confidence")}</strong>{t(`connection.confidence.${selectedEdgeDetails?.confidence ?? "inferred"}`)}</span>
            </div>
            <label>
              {t("connection.source")}
